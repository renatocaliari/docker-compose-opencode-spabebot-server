...
* **🐝 [opencode-hive](https://github.com/tctinh/agent-hive):** shifts the single-agent experience into a swarm system focused on context management and traceability. the master agent delegates specific tasks to sub-agents (researchers, reviewers).
